...
const Footer = () => {
  ...
  return (
    <Box className='general-footer' sx={{mt: 'auto'}}>
      <Box className='footer-advantages'
        sx={{ display: 'flex', flexDirection: {xs: 'column', sm: 'row'}, justifyContent: 'center', alignItems: 'center', gap: '2rem', my: '3rem' }}>
        ...
        <Container>
          <Box sx={{ display: 'flex', gap: '1rem', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', mb: '2rem' }}>
            ...
            <Box sx={{ alignSelf: { sx: 'space-between', md: 'center' }, display: 'flex', flexDirection: { xs: 'column', lg: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'start', lg: 'center' }, gap: '1rem' }}>
              <TextField color='primary' id='email-text-field' placeholder='Your Email' label='Your Email' variant='outlined' sx={{ backgroundColor: 'rgba(255,255,255, .8)', borderRadius: '4px', width: {xs: '100%', sm: '390px'} }} />
          ...
          >
            <Grid item xs={12} sm={6} lg={3}>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: '6px', alignItems: 'start', justifyContent: 'start' }}>
                ...
                <Typography component={NavLink} to='/aboutUs' sx={{textDecoration: 'none', fontWeight: '400', fontSize: '14', color: 'rgb(255,255,255)' }}>
                  About Us
                </Typography>
                ...
                <Typography component={NavLink} to='/userAccount' sx={{ textDecoration: 'none', fontWeight: '400', fontSize: '14', color: 'rgb(255,255,255)' }}>
