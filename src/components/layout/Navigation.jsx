...
import { Button, Link, List, ListItem, Divider, ListItemText, Typography } from '@mui/material'
...
<Box sx={{display: {xs: 'none', lg: 'block'}}}>
        <ControlledMenu {...menuProps} anchorRef={ref}
          ...
          <Link to='/products/headphones' component={NavLink} sx={{color: 'inherit', textDecoration: 'none'}}>
          ...
          <Link to='/products/usb' component={NavLink} sx={{color: 'inherit', textDecoration: 'none'}}>
          <SubMenu label='USB'>
            <MenuHeader>
              Capacity
            </MenuHeader>
          ...
          <Link to='/products/chargets' component={NavLink} sx={{color: 'inherit', textDecoration: 'none'}}>
          ...
          <Link to='/products/powerbank' component={NavLink} sx={{color: 'inherit', textDecoration: 'none'}}>
          ...
          <Link to='/products/adapters' component={NavLink} sx={{color: 'inherit', textDecoration: 'none'}}>
          ...
          <Link to='/products/keyboard' component={NavLink} sx={{color: 'inherit', textDecoration: 'none'}}>
