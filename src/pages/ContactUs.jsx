...
function ContactUs() {
    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', flexDirection: {xs: 'column', md:'row'}, gap: '3rem', alignItems: 'start'}}>
                ...
                <Box className='contacts-form' sx={{flexBasis: '50%', flexGrow: '1'}}>
                    ...
                    >
                        ...
                        <Box sx={{
                            display: 'flex', flexDirection: {xs: 'column', lg: 'row'}, gap: '1.5rem', alignItems: 'stretch',
                        ...
                        <Button
                            variant='contained'
                            sx={{ px: '2rem' }}
                            onClick={()=>alert('The form is submitted')}
                            >
                            Submit
                        </Button>
