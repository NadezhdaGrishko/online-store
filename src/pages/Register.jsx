...
const Register = () => {
    ...
    const handleRegister = () => {
        createUserWithEmailAndPassword(auth, userEmail, userPassword)
            .then((userCredential) => {
                ...
                auth.currentUser.displayName = ctx.userName;
                console.log(user);
    ...
    const validateName = (e) => {
        ...
        e.target.value === '' ? setErrorName('This field is required') : setErrorName('');
        auth.currentUser.displayName = e.target.value;
    }
    ...
    const validateEmail = (e) => {
        ...
        } else if (/\S+@[a-zA-Z0-9]+\.[A-Za-z]+$/.test(e.target.value)) { 
