  ...
  return (
    <>
      ...
      >
        ...
        >
          <Tab sx={{ textTransform: 'capitalize', alignSelf: 'start', fontSize: '15px', pl: '1.5rem', width: '100%', alignItems: 'start' }} label="Account Dashboard" {...a11yProps(0)} />
          <Tab sx={{ textTransform: 'capitalize', alignSelf: 'start', fontSize: '15px', pl: '1.5rem', width: '100%', alignItems: 'start' }} label="Account Information" {...a11yProps(1)} />
          <Tab sx={{ textTransform: 'capitalize', alignSelf: 'start', fontSize: '15px', pl: '1.5rem', width: '100%', alignItems: 'start' }} label="Address Book" {...a11yProps(2)} />
          <Tab sx={{ textTransform: 'capitalize', alignSelf: 'start', fontSize: '15px', pl: '1.5rem', width: '100%', alignItems: 'start' }} label="My Orders" {...a11yProps(3)} />
          <Divider sx={{ ml: '.75rem', mr: '1rem' }} />
          <Tab sx={{ textTransform: 'capitalize', alignSelf: 'start', fontSize: '15px', pl: '1.5rem', width: '100%', alignItems: 'start' }} label="My Wish List" {...a11yProps(4)} />
          <Tab sx={{ textTransform: 'capitalize', alignSelf: 'start', fontSize: '15px', pl: '1.5rem', width: '100%', alignItems: 'start' }} label="My Product Reviews" {...a11yProps(5)} />
          <Tab sx={{ textTransform: 'capitalize', alignSelf: 'start', fontSize: '15px', pl: '1.5rem', width: '100%', alignItems: 'start' }} label="Newsletter Subscriptions" {...a11yProps(6)} />
        ...
        <TabPanel value={value} index={6}>
          ...
          <Typography sx={{ fontSize: '18px', fontWeight: '700', }}>
            My Products Reviews <Typography component={Link} href='#' color='main' sx={{ fontSize: '14px', fontWeight: '300', ml: '1rem' }}>
              Manage Address
            </Typography>
          </Typography>
          <Divider sx={{ my: '1rem', width: '100%' }} />
